...
export function OverviewPage() {
  ...
  return (
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      {/* HERO SECTION */}
      <div className={`p-8 rounded-[24px] relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-6 ${isDark
              ...
              {loading ? (
                ...
                recentSightings.map((sighting) => (
                  <div key={sighting.id} className={`relative pl-14 transition-all duration-300 group cursor-pointer`} onClick={() => navigate(`/sighting-alerts/${sighting.id}`)}>
                    {/* Timeline Node */}
                    <div className={`absolute left-0 top-1.5 w-12 h-12 rounded-full flex items-center justify-center shadow-lg border-4 ${isDark ? "border-[#0B1120]" : "border-white"
                    ...
                    {/* Content Card */}
                    <div className={`p-4 rounded-2xl border transition-all duration-300 ${isDark
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full flex items-center justify-between p-4 rounded-xl border transition-all duration-300 hover:-translate-y-1 ${isDark
